...
class test_vhf(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "VHF Spectrum Analyzer", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("VHF Spectrum Analyzer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_vhf")
        ...
        self._rx_freq_range = Range(100e6, 250e6, 1e6, 140e6, 200)
...
def main(top_block_cls=test_vhf, options=None):
