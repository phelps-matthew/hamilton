...
class test_uhf(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "UHF Spectrum Analyzer", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("UHF Spectrum Analyzer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_uhf")
...
def main(top_block_cls=test_uhf, options=None):
