...
class vhf_gps(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "VHF Sigmf Recording", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("VHF Sigmf Recording")
        ...
        self.settings = Qt.QSettings("GNU Radio", "vhf_gps")
...
def main(top_block_cls=vhf_gps, options=None):
