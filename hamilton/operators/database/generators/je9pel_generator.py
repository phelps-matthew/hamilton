...
class JE9PELGenerator:
    ...
    def generate_db(self, use_cache=False):
        logger.info("Starting JE9PEL data generation.")
        ...
        logger.info(f"Total number of observable JE9PEL satellites: {len(data)}")
        logger.info("JE9PEL database generation complete.")

        return data


if __name__ == "__main__":
    generator = JE9PELGenerator(DBUpdaterConfig)
